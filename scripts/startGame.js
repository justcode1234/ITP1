function startGame(){
    ...
    lives -= 1;
    enemies = [];
    enemies.push(new enermy(300,  floorPos_y - 10, 300,1));
    enemies.push(new enermy(900,  floorPos_y - 10, 250,1));
    enemies.push(new enermy(1420, floorPos_y - 10, 250,1));
    enemies.push(new enermy(1970, floorPos_y - 10, 250,1));
